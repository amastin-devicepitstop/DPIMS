...
function confirmDelete(element) {
  ...
  if (element.closest(".transaction-column").find("#title-buys").length !== 0) {
    ...
    element.closest(".actions").append("<span id='sale-column' class='no-display'></span>")
  }
